...
public class ProcessDao {
    ...
    public static List<CashProcess> findAllByNationalId(String nationalId) {
        ...
        try (PreparedStatement preparedStatement = con.prepareStatement(query)) {
            ...
            while (result.next()) {
                CashProcess process = new CashProcess(result.getInt("id"), result.getString("name"),
                        ...
                        result.getDate("date").toLocalDate(), result.getString("description"),
    ...
    public static void save(CashProcess process) {
        Connection con = DbConnection.getConnection();
        if (con == null) {
            return;
        }
