...
public class AccountDao {
    ...
    public static Account findByNationalId(String nationalId) {
        ...
        try (PreparedStatement preparedStatement = con.prepareStatement(query)) {
            ...
            while (result.next()) {
                Account account = new Account(result.getInt("id"), result.getString("name"),
                        result.getString("nationalId"), result.getString("password"),
                        result.getDate("birthday").toLocalDate(), result.getString("phone"),
                        result.getDouble("balance"), result.getDouble("creditBalance"),
                        result.getString("creditCardNumber"), result.getDouble("creditBalanceLimit"),
                        result.getDate("creditDate").toLocalDate(), result.getDate("creditEndDate").toLocalDate(),
                        result.getBoolean("status"), result.getBoolean("gender"), result.getBoolean("info"));
                return account;
            }
